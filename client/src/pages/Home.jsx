    ...
    return (
        <div className="home-container">
            ...
            <div className="home-left">
                <h1>This is the Job Portal!</h1>
                <p className="home-intro">We are the Best!!</p>
                <h2>Welcome to Job Portal</h2>
                <p className="home-description">
                    Are you ready to take to next level with cutting-edge IT solutions? Look no further! 
                    At Job Portal, we specialize in providing innovative IT services solutions tailored 
